...
if args.dataset_type == 'diverse':
    ...
    for window in windowSizes:
        ...
        test_loader  = DataLoader(dataset=test_dataset, batch_size=4, shuffle=False, num_workers=4, drop_last=False, pin_memory=True)
        result_dir = os.path.join(args.result_dir, 'GoPro_window%d'%(window))
